  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent className="overflow-hidden p-0">
        <Command className={commandClassNames.command}>
          {children}
        </Command>
      </DialogContent>
    </Dialog>
...
const commandClassNames = {
  command: [
    ...
    "[&_cmdk-input-wrapper]_svg:h-5 [&_cmdk-input-wrapper]_svg:w-5",
    "[&_cmdk-input]:h-12",
    "[&_cmdk-item]:px-2 [&_cmdk-item]:py-3 [&_cmdk-item]_svg:h-5 [&_cmdk-item]_svg:w-5",
  ].join(" "),
};
